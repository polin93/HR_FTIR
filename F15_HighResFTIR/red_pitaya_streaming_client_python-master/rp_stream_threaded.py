...
if __name__ == "__main__":
    ...
    data2 = np.ones(16384*recordlength, dtype = np.dtype(np.int16))
    print("theor. time: ", 1/1940000*16384*recordlength)
    t1 = time.time()
...
#            data = np.append(data,a.data['bytes_data1'] )
            data2[(i-1)*16384:i*16384] = a.data['bytes_data1'] 
...
#            i=0
    ...
    plt.figure()
    plt.semilogy(np.abs(np.fft.rfft(np.blackman(len(data2))*detrend(data2))))
